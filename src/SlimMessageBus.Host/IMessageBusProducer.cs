namespace SlimMessageBus.Host
{
    ...
    {
        Task Publish(Type messageType, object message, string path = null, IDictionary<string, object> headers = null, IDependencyResolver currentDependencyResolver = null);
