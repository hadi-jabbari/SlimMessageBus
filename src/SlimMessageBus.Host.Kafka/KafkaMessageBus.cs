namespace SlimMessageBus.Host.Kafka
{
    ...
    public class KafkaMessageBus : MessageBusBase
    {
        ...
        public IProducer CreateProducerInternal()
        {
            ...
            logger.LogDebug("Producer settings: {0}", config);
        ...
        private void CreateProducer()
        {
            ...
            logger.LogInformation("Created producer {0}", producer.Name);
        }
        ...
        private void CreateGroupConsumers()
        {
            ...
            logger.LogInformation("Created {0} group consumers", groupConsumers.Count);
        }
